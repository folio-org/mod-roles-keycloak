...
-- Foo Item | Manage
INSERT INTO capability_set(id, name, description, resource, action, type, folio_permission, application_id, created_by_user_id, visible)
VALUES ('a1002e06-a2bc-4ce4-9d71-e25db1250e09', 'foo_item.manage', 'Capability set to manage a foo item',
        'Foo Item', 'MANAGE', 'DATA', 'foo.item.all', 'test-application-0.0.1', '11111111-1111-4011-1111-0d121a11111e', false);
...
VALUES ('a8ec43cc-f38d-4d34-9e5c-39815ffd099c', 'foo_item_v2.manage', 'Capability set to manage a foo item v2',
        ...
        '11111111-1111-4011-1111-0d121a11111e', false);

INSERT INTO capability_set_capability(capability_set_id, capability_id)
VALUES ('a8ec43cc-f38d-4d34-9e5c-39815ffd099c', 'e1a5683a-fece-43fb-bbaa-52a438af9807');

-- Foo Item | View
INSERT INTO capability_set(id, name, description, resource, action, type, folio_permission, application_id, visible)
VALUES ('8812fa56-1e07-4bea-87a8-16b548f7e4fc', 'foo_item.view', 'Capability set to view a foo item',
        'Foo Item', 'VIEW', 'DATA', 'foo.item.view', 'test-application-0.0.1', false);
...
VALUES ('6532d4f8-3e97-4d8b-886f-4ec2a2adc4a3', 'foo_item.edit', 'Capability set to edit a foo item',
        'Foo Item', 'EDIT', 'DATA', 'foo.item.edit', 'test-application-0.0.1', false);
...
VALUES ('55a910de-cecf-4e0e-9d35-2e8e2ecf699e', 'foo_item.create', 'Capability set to create a foo item',
        ...
        'test-application-0.0.1', '11111111-1111-4011-1111-0d121a11111e', false);
