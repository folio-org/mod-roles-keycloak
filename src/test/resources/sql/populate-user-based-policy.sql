INSERT INTO test_mod_roles_keycloak.policy(id, name, description, type, source, created_by_user_id)
VALUES ('1e111e11-1111-401c-ad8e-0d121a11111e', 'user-based-policy', 'hello work', 'USER', 'USER',
