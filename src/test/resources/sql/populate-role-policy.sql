...
insert into policy(id, name, description, type, logic)
values ('dec68c30-4f93-4481-95bd-9ec587b15c1c', 'Policy for role: test-role',
        'System generated policy for role: test-role', 'ROLE', 'POSITIVE');
