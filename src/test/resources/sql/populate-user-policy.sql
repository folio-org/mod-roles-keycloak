...
INSERT INTO policy(id, name, description, type, logic, created_date, created_by)
VALUES ('ce49bb90-0a59-4f74-a25c-2dbb2728cdf6', 'Policy for user: test-user',
        'System generated policy for user: test-user', 'USER', 'POSITIVE',
