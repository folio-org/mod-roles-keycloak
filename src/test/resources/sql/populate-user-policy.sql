...
INSERT INTO policy(id, name, description, type, source, logic, created_date, created_by_user_id)
VALUES ('ce49bb90-0a59-4f74-a25c-2dbb2728cdf6', 'Policy for user: 3e8647ee-2a23-4ca4-896b-95476559c567',
        'System generated policy for user: 3e8647ee-2a23-4ca4-896b-95476559c567', 'USER', 'USER','POSITIVE',
