...
VALUES ('60a691b2-d5ee-4845-84f7-b3f68ab6ec13', 'foo_item.view', 'foo_item.view - description', 'Foo Item',
        'foo.item.view', 'foo-module-1.0.0', NULL, '2023-10-24 13:39:51', 'VIEW', 'DATA', 'test-application-0.0.1'),
       ('3d159575-2533-4351-94b0-2a4255c05c2c', 'foo_item.edit', 'foo_item.edit - description', 'Foo Item',
        'foo.item.edit', 'foo-module-1.0.0', NULL, '2023-10-24 13:39:52', 'EDIT', 'DATA', 'test-application-0.0.1'),
       ('12277da3-d05d-41de-ae74-0e8ec59f1dcc', 'foo_item.create', 'foo_item.create - description', 'Foo Item',
        'foo.item.create', 'foo-module-1.0.0', NULL, '2023-10-24 13:39:53', 'CREATE', 'DATA', 'test-application-0.0.1'),
       ('8b117697-ecf3-47d8-84c9-d5d1734e0237', 'foo_item.manage', 'foo_item.manage - description', 'Foo Item',
        'foo.item.all', 'foo-module-1.0.0', NULL, '2023-10-24 13:39:54', 'MANAGE', 'DATA', 'test-application-0.0.1');
